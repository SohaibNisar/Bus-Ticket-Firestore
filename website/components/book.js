            ...
            <Consumer>
                {(value) => {
                    if (value.state.details === 'nothing') {
                        ...
                        return (
                            <div className='container my-5' id='book-container'>
                                {value.state.details && value.state.details.map((x, i) => {
                                    return (
                                        <div key={i} className='box'>
                                            <div className='details'>
                                                <div className='row m-0'>
                                                    <h4 className='col-md-10 col-8 border-bottom m-0 p-0'>{x.bus}</h4>
                                                ...
                                                <div className='row m-0'>
                                                    ...
                                                    <div className='col-md-2 col-4 p-0 py-3 text-center border-left'>
                                                        <button className="btn btn-primary" type="button" onClick={() => value.book(x.bus, x.key, x.amount, x.arrivalTime, x.departureTime)}>
                                                            Book
                                                </button>
                                                    </div>
                                                </div>
